...
const discoverGallery = [{img:discover_2, text:"Parties"},{img:discover_3, text:"Relax"},{img:discover_1, text:"Weddings"}]
  ...
  return (
    <div>
      ...
      <div class=" relative w-[50%] mx-auto my-16 text-center" data-aos="fade-zoom-in" data-aos-duration="600">
      ...
      <div class=" flex gap-4 items-center justify-center mb-20">
        {gallery.map((img)=>(
          <img src={img} width={"200px"} data-aos="fade-up" data-aos-dela="100" data-aos-duration="600" />
        ))}
      </div>
      ...
      <div>
        <div class=" flex">
          <img src={rooms_1} width={"50%"} data-aos="fade-right" data-aos-duration="600"/>
          <div class="w-[50%] bg-[#F5F6F7] flex justify-center items-center">
            <div class="w-[80%]" data-aos="fade-up" data-aos-dela="200" data-aos-duration="600">
        ...
        <div class=" flex flex-row-reverse">
          <img src={rooms_2} width={"50%"} data-aos="fade-left" data-aos-dela="400" data-aos-duration="600"/>
          <div class="w-[50%] bg-[#2A0135] flex justify-center items-center text-white">
            <div class="w-[80%]" data-aos="fade-up" data-aos-dela="600" data-aos-duration="600">
              <div class=" relative mb-[-1.8rem]">
      ...
      <div class=" flex justify-center items-center pb-14">
        <div class=" relative w-[30%]" data-aos="flip-up" data-aos-dela="800" data-aos-duration="600">
        ...
        <div class=" w-[30%]" data-aos="flip-down" data-aos-dela="800" data-aos-duration="600">
        ...
        {discoverGallery.map((discovery)=>{
          ...
          return(
            <div class=" bg-black relative">
              ...
              <p class=" absolute top-[50%] left-[45%] text-white text-xl font-bold" data-aos="fade" data-aos-dela="50" data-aos-duration="600">{discovery.text}</p>
            </div>
          )
        })}
      </div>
